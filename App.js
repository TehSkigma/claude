...
function Btn({ label, onPress, loading, style }) {
  return (
    ...
    <LinearGradient colors={['#0f0f1a', '#1a1a2e']} style={{ flex: 1 }}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ padding: 20, paddingTop: 56, paddingBottom: 40 }} keyboardShouldPersistTaps="handled">
          ...
          <Text style={{ fontSize: 14, color: '#888', marginBottom: 24 }}>Describe your goal and equipment to get a custom 30-min routine</Text>
          <View style={{ backgroundColor: '#1e1e2e', borderRadius: 18, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: '#2a2a3e' }}>
            ...
            <Text style={{ fontSize: 11, color: '#555' }}>Get one free at console.anthropic.com</Text>
          </View>
          <View style={{ backgroundColor: '#1e1e2e', borderRadius: 18, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: '#2a2a3e' }}>
          ...
          {routine && (
            <View style={{ backgroundColor: '#1e1e2e', borderRadius: 18, overflow: 'hidden', borderWidth: 1, borderColor: '#2a2a3e' }}>
              ...
              {!saved
                ...
                : <View style={{ margin: 16, backgroundColor: '#0d2b17', borderRadius: 12, padding: 14, alignItems: 'center' }}><Text style={{ color: '#4ade80', fontWeight: '700' }}>✓ Saved</Text></View>}
            </View>
          )}
        </ScrollView>
      </KeyboardAvoidingView>
    ...
    <LinearGradient colors={['#0f0f1a', '#1a1a2e']} style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingTop: 56, paddingBottom: 40 }}>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 28 }}>
          {[
            { num: sessions.filter(s => new Date(s.completedAt) >= weekAgo).length, label: 'This week' },
